...

{
    ...
    public async Task<ResultModel<string>> ResetPasswordAsync(Guid id)
        => await HttpHelper.SendAsync<IUserController, ResultModel<string>>(ProjectName, ModuleName, nameof(ResetPasswordAsync), []);
    /// <summary>
    /// 修改密码
    /// </summary>
    ...
    public async Task<ResultModel> ChangePasswordAsync(ChangePasswordRequestModel requestModel)
        => await HttpHelper.SendAsync<IUserController, ResultModel>(ProjectName, ModuleName, nameof(ChangePasswordAsync), []);
    /// <summary>
    /// 获得登录用户信息
    /// </summary>
    /// <returns></returns>
    ...
    public async Task<ResultModel<LoginResultDTO>> LoginAsync(LoginRequestModel requestModel)
        => await HttpHelper.SendAsync<IUserController, ResultModel<LoginResultDTO>>(ProjectName, ModuleName, nameof(LoginAsync), []);
}
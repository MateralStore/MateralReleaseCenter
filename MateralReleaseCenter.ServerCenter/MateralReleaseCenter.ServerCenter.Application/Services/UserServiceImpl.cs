...
public partial class UserServiceImpl(IOptionsMonitor<ApplicationConfig> config)
{
    ...
    public async Task<UserDTO> LoginAsync(LoginModel model)
    {
        ...
        if (!domain.Password.Equals(EncodePassword(model.Password))) throw new MateralReleaseCenterException("密码错误");
    ...
    public async Task ChangePasswordAsync(ChangePasswordModel model)
    {
        ...
        if (!domain.Password.Equals(EncodePassword(model.OldPassword))) throw new MateralReleaseCenterException("旧密码错误");

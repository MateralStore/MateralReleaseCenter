...
using MateralReleaseCenter.DeployServer.ServiceImpl.Models;
...
namespace MateralReleaseCenter.DeployServer.Application.Services.Models
{
    ...
    public class ApplicationRuntimeModel(IServiceProvider serviceProvider, ApplicationInfo applicationInfo, IOptionsMonitor<ApplicationConfig> applicationConfig) : IApplicationRuntimeModel
    {
        ...
        public ApplicationInfo ApplicationInfo
        {
            ...
            {
                if (ApplicationStatus != ApplicationStatusEnum.Stop) throw new MateralReleaseCenterException("应用程序尚未停止");
        ...
        /// 压缩包文件组文件夹路径
        /// </summary>
        public string RarFilesDirectoryPath => Path.Combine(typeof(DeployServerModule).Assembly.GetDirectoryPath(), applicationConfig.CurrentValue.UploadFilePath, ApplicationInfo.Name);
        /// <summary>
        /// 发布文件夹路径
        /// </summary>
        public string PublishDirectoryPath => Path.Combine(typeof(DeployServerModule).Assembly.GetDirectoryPath(), "Application", ApplicationInfo.RootPath);
        /// <summary>
        /// 执行启动任务
        /// </summary>

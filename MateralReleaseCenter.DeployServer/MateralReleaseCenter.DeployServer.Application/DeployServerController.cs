namespace MateralReleaseCenter.DeployServer.Application
{
    ...
    /// DeployServer控制器
    /// </summary>
    [Route("DeployServerAPI/[controller]/[action]")]
    public abstract class DeployServerController : MergeBlockController
    {
    }
    /// <summary>
    /// DeployServer控制器
    ...
    [Route("DeployServerAPI/[controller]/[action]")]
    public abstract class DeployServerController<TService> : MergeBlockController<TService>
    ...
    /// <typeparam name="TService"></typeparam>
    [Route("DeployServerAPI/[controller]/[action]")]
    public abstract class DeployServerController<TAddRequestModel, TEditRequestModel, TQueryRequestModel, TAddModel, TEditModel, TQueryModel, TDTO, TListDTO, TService> : MergeBlockController<TAddRequestModel, TEditRequestModel, TQueryRequestModel, TAddModel, TEditModel, TQueryModel, TDTO, TListDTO, TService>

...
/// RC控制器HTTP帮助类
/// </summary>
public class MateralReleaseCenterControllerHttpHelper(IHttpHelper httpHelper, ITokenService tokenService, IOptionsMonitor<WebOptions> config, IOptionsMonitor<MergeBlockOptions> mergeBlockConfig, ILoggerFactory? loggerFactory = null) : AuthorizationControllerHttpHelper(httpHelper, tokenService, config, mergeBlockConfig, loggerFactory)
{
    /// <summary>
    /// 获取URL
    /// </summary>

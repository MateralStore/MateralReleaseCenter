...
/// DeployServer模块
/// </summary>
[DependsOn(typeof(DeployServerRepositoryModule))]
public class DeployServerModule() : MateralReleaseCenterModule("MateralReleaseCenterDeployServer模块")
{
    /// <inheritdoc/>
    ...
    //    string basePath = typeof(DeployServerModule).Assembly.GetDirectoryPath();
